...
// Blit to screen
bool j1Render::BlitParal(SDL_Texture* texture, int x, int y, const SDL_Rect* section, float speed, double angle, int pivot_x, int pivot_y, SDL_RendererFlip flip) const
{
	bool ret = true;
	uint scale = App->win->GetScale();
